...
export default class QuidditchCalendar extends React.Component<IQuidditchCalendarProps, {}> {
  public render(): React.ReactElement<IQuidditchCalendarProps> {
    ...
    return (
      <section className={`${styles.quidditchCalendar} ${hasTeamsContext ? styles.teams : ''}`}>
